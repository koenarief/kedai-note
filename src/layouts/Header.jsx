                      ...
                      <div className="sherah-header__right">
                                ...
                                <div className="sherah-chatbox__inner">
                                  <div className="sherah-chatbox__author">
                                    <div className="sherah-chatbox__author-img">
                                      <img
                                        src="shopo-admin/img/chat-author1.png"
                                        alt="#"
                                      />
                              ...
                              <li>
                                <div className="sherah-chatbox__inner">
                                  <div className="sherah-chatbox__author">
                                    <div className="sherah-chatbox__author-img">
                                      <img
                                        src="shopo-admin/img/chat-author2.png"
                                        alt="#"
                                      />
                              ...
                              <li>
                                <div className="sherah-chatbox__inner">
                                  <div className="sherah-chatbox__author">
                                    <div className="sherah-chatbox__author-img">
                                      <img
                                        src="shopo-admin/img/chat-author3.png"
                                        alt="#"
                                      />
                                      <span className="sherah-chatbox__author-online author-not-online"></span>
                                    </div>
                              ...
                              <li>
                                <div className="sherah-chatbox__inner">
                                  <div className="sherah-chatbox__author">
                                    <div className="sherah-chatbox__author-img">
                                      <img
                                        src="shopo-admin/img/chat-author4.png"
                                        alt="#"
                                      />
                                      <span className="sherah-chatbox__author-online"></span>
                                    </div>
                              ...
                              <li>
                                <div className="sherah-chatbox__inner">
                                  <div className="sherah-chatbox__author">
                                    <div className="sherah-chatbox__author-img">
                                      <img
                                        src="shopo-admin/img/chat-author5.png"
                                        alt="#"
                                      />
                        ...
                        <div className="sherah-header__author sherah-flex__center--top">
                          <div className="sherah-header__author-img">
                            <img
                              src="shopo-admin/img/profile-pic.png"
                              alt="#"
                            />
                          </div>
